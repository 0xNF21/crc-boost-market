...
Journal de décision pour la brique 8 :

- Décidé : livrer d'abord le report comme une surface agrégée dans le creator dashboard, sans détail nominatif des claimants.
