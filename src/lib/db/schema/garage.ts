...
export const garageReferralRewards = pgTable(
  "garage_referral_rewards",
  {
    ...
    baseAmountCrc: real("base_amount_crc").notNull().default(0),
    qualityMultiplier: real("quality_multiplier").notNull().default(1),
    referredTrustScore: integer("referred_trust_score"),
    referredTrustLevel: text("referred_trust_level"),
    referredBackerStatus: text("referred_backer_status"),
