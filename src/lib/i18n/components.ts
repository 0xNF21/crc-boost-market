...
export const componentsTranslations = {
  ...
  quickReplay: {
    ...
    demoPay: { fr: "Jouer {amount} (demo)", en: "Play {amount} (demo)" },
  ...
  pnlCard: {
    grossLabel: { fr: "Recompense brute", en: "Gross reward" },
    betLost: { fr: "Participation utilisee", en: "Entry used" },
    playerDefault: { fr: "Joueur", en: "Player" },
    betLabel: { fr: "Participation", en: "Entry" },
    copy: { fr: "Copier", en: "Copy" },
    copied: { fr: "Copie", en: "Copied" },
    share: { fr: "Partager", en: "Share" },
    imageLabel: { fr: "Image", en: "Image" },
    tweetWin: {
      fr: "{amount} sur {gameName} ! \uD83C\uDFC6\n\nJoue sur NF Society \uD83D\uDC49 https://nf-society.vercel.app",
      en: "{amount} on {gameName}! \uD83C\uDFC6\n\nPlay on NF Society \uD83D\uDC49 https://nf-society.vercel.app",
    },
    tweetReward: {
      fr: "{amount}{tier} sur {gameName} ! \uD83C\uDFB0\n\nhttps://nf-society.vercel.app",
      en: "{amount}{tier} on {gameName}! \uD83C\uDFB0\n\nhttps://nf-society.vercel.app",
    },
  },
  miniapp: {
  ...
  wallet: {
    ...
    errorWrongBet: { fr: "Participation invalide", en: "Invalid entry" },
    ...
    errorInvalidBet: { fr: "Participation non autorisee pour cette table", en: "Entry not allowed on this table" },
    ...
    payWithBalance: { fr: "Participer avec mon solde", en: "Join with my balance" },
    available: { fr: "dispo", en: "available" },
    payFromBalanceBtn: {
      fr: "Utiliser %AMOUNT% CRC depuis mon solde",
      en: "Use %AMOUNT% CRC from my balance",
    },
    ...
    orPayDirect: {
      fr: "ou utiliser le flux Circles direct ci-dessous",
      en: "or use the direct Circles flow below",
    },
    // Phase 3d — cashout
    ...
    historyKindDebit: { fr: "Participation", en: "Entry" },
    historyKindPrize: { fr: "Recompense", en: "Reward" },
    ...
    historyKindGameBet: { fr: "Participation", en: "Entry" },
    historyKindGamePrize: { fr: "Recompense", en: "Reward" },
    historyKindDailyTicket: { fr: "Participation Daily legacy", en: "Legacy Daily entry" },
  },
  statsFragments: {
    ...
    colWagered: { fr: "Engages", en: "Played" },
    colPaidOut: { fr: "Distribues", en: "Distributed" },
