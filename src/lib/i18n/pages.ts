...
export const pagesTranslations = {
  ...
  profile: {
    ...
    disconnectedTitle: { fr: "Vous êtes bien déconnecté", en: "You are signed out" },
    disconnectedHint: {
      fr: "Ton profil n'est plus lié à cette session.",
      en: "Your profile is no longer linked to this session.",
    },
    reconnectPrompt: { fr: "Reconnectez-vous ?", en: "Sign back in?" },
  },
  playerProfile: {
    ...
    crcBet: { fr: "Participations", en: "Participations" },
    crcWon: { fr: "Recompenses", en: "Rewards" },
  ...
  stats: {
    ...
    casinoBankDesc: {
      fr: "Vue du solde on-chain legacy et du pool communautaire",
      en: "View of legacy on-chain balance and community pool",
    },
    innerCrc: { fr: "Pool principal", en: "Main pool" },
    ...
    volumeChart: { fr: "Activite arcade sur 30 jours", en: "Arcade activity over 30 days" },
    byGame: { fr: "Par jeu", en: "Per game" },
    colGame: { fr: "Jeu", en: "Game" },
    colVolume: { fr: "Participations", en: "Participations" },
    ...
    colBet: { fr: "Participation", en: "Entry" },
